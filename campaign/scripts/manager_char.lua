...
function addBackgroundRef(nodeChar, sClass, sRecord)
	...
	if sSkills ~= "" and sSkills ~= "None" then
		...
		elseif sSkills:match("and one Intelligence, Wisdom, Charisma, Sanity skill of your choice, as appropriate to your faction") then
			sSkills = sSkills:gsub("and one Intelligence, Wisdom, Charisma, or Sanity skill of your choice, as appropriate to your faction", "");
			
			nPicks = 1;
			for k,v in pairs(DataCommon.skilldata) do
				if (v.stat == "intelligence") or (v.stat == "wisdom") or (v.stat == "charisma") or (v.stat == "sanity") then
