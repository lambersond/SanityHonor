...
function linkPCFields(nodePS)
	...
	PartyManager.linkRecordField(nodeChar, nodePS, "abilities.sanity.score", "number", "sanity");
	PartyManager.linkRecordField(nodeChar, nodePS, "abilities.honor.score", "number", "honor");
