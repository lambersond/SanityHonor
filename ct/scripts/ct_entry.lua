...
function linkPCFields()
	...
	if nodeChar then
		...
		sanity.setLink(nodeChar.createChild("abilities.sanity.score", "number"), true);
		honor.setLink(nodeChar.createChild("abilities.honor.score", "number"), true);
...
function setAttributesVisible()
	...
	sanity.setVisible(v);
	sanity_label.setVisible(v);
	honor.setVisible(v);
	honor_label.setVisible(v);
